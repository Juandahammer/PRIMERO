...
void main (void)
{
    ...
    strcpy(cad1, cad0);
    printf("\nPrueba de la funcion strncpy. Se copia la cadena cad0 a cad1: %s\n", cad1);
    strcpy(cad1, "XX");
    printf("\nPrueba de la funcion srtcpy. Se copia la cadena XX a cad1: %s\n", cad1);
    strncpy(cad2, cad0, 4);
    cad2[4]='\0';
    printf("\nPrueba de la funcion strncpy. Se cpian 4 caracteres de cad0 a cad2: %s\n", cad2);
    strncpy(cad2, cad3, 3);
    cad2[3]='\0';
    printf("\nPrueba de la funcion strncpy. Se copian 3 caracteres e cad3 a cad2: %s\n", cad2);
    strcat(cad0, cad3);
